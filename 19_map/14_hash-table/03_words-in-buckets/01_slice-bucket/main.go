...
func main() {
	...
	buckets := make([][]string, 12) // a slice holding a slice of string, 12 spots (slices), and each spot storing a string
	...
	// fmt.Println(len(buckets)) // 12
	// fmt.Println(cap(buckets)) // 12
}
